...
interface UpdateCompany extends Static<typeof updateCompanySchema> {}

export async function updateCompany(id: number, body: UpdateCompany) {
	await companyRepo.update(id, body);
